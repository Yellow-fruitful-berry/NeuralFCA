...
one_hot_encoded_df[['not_VEHICLE_OWNERSHIP']] = ~one_hot_encoded_df[['VEHICLE_OWNERSHIP']] #, 'not_MARRIED', 'not_CHILDREN']] = one_hot_encoded_df[['VEHICLE_OWNERSHIP', 'MARRIED', 'CHILDREN']]
